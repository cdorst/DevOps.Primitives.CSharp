...
namespace DevOps.Primitives.CSharp
{
    ...
    public class TypeParameterListAssociation : IUniqueListAssociation<TypeParameter>
    {
        ...
        public TypeParameterListAssociation(in TypeParameter typeParameter, in TypeParameterList typeParameterList = default)
        {
            TypeParameter = typeParameter;
            TypeParameterList = typeParameterList;
        }
        public TypeParameterListAssociation(in Identifier typeParameter, in TypeParameterList typeParameterList = default)
            : this(new TypeParameter(in typeParameter), in typeParameterList)
        {
        }
        public TypeParameterListAssociation(in string typeParameter, in TypeParameterList typeParameterList = default)
