...
{
    public class CSharpDbContext : UniqueStringsDbContext
    {
        ...
        private void AddIndexes(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AttributeListCollection>()
                .HasIndex(e => new { e.ListIdentifierId }).IsUnique();
            ...
            modelBuilder.Entity<Parameter>()
                .HasIndex(e => new { e.AttributeListCollectionId, e.DefaultValueId, e.IdentifierId, e.TypeId, e.ModifierId }).IsUnique();
