...
namespace DevOps.Primitives.CSharp
{
    ...
    public class StatementListAssociation : IUniqueListAssociation<Statement>
    {
        ...
        public StatementListAssociation(in Statement statement, in StatementList statementList = default)
        {
            Statement = statement;
            StatementList = statementList;
        }
        public StatementListAssociation(in AsciiMaxStringReference statement, in StatementList statementList = default)
            : this(new Statement(in statement), in statementList)
        {
        }
        public StatementListAssociation(in string statement, in StatementList statementList = default)
