...
namespace DevOps.Primitives.CSharp
{
    ...
    public class ArgumentListAssociation : IUniqueListAssociation<Argument>
    {
        ...
        public ArgumentListAssociation(in Argument argument, in ArgumentList argumentList = default)
        {
            Argument = argument;
            ArgumentList = argumentList;
        }
        public ArgumentListAssociation(in Identifier argument, in ArgumentList argumentList = default)
            : this(new Argument(in argument), in argumentList)
        {
        }
        public ArgumentListAssociation(in string argument, in ArgumentList argumentList = default)
