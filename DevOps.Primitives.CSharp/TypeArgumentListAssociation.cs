...
{
    [ProtoContract]
    [Table("TypeArgumentListAssociations", Schema = nameof(CSharp))]
    public class TypeArgumentListAssociation : IUniqueListAssociation<TypeArgument>
    {
        public TypeArgumentListAssociation() { }
        public TypeArgumentListAssociation(in TypeArgument typeArgument, in TypeArgumentList typeArgumentList = default)
        {
            TypeArgument = typeArgument;
            TypeArgumentList = typeArgumentList;
        }
        public TypeArgumentListAssociation(in Identifier typeArgument, in TypeArgumentList typeArgumentList = default)
            : this(new TypeArgument(in typeArgument), in typeArgumentList)
        {
        }
        public TypeArgumentListAssociation(in string typeArgument, in TypeArgumentList typeArgumentList = default)
